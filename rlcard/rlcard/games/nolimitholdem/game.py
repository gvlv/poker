...
from player import Player as ParserPlayer
...
class NolimitholdemGame(Game):
    ...
    def init_game(self):
        ...
        self.__players: Dict[int, ParserPlayer] = dict(
            [(player.player_id, ParserPlayer(position, player.player_id, player.in_chips))
