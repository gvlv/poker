class BasePokerPlayer(object):
  ...
  def declare_action(self, valid_actions, hole_card, round_state, hand=None):
  ...
  def respond_to_ask(self, message):
    ...
    valid_actions, hole_card, round_state, hand = self.__parse_ask_message(message)
    return self.declare_action(valid_actions, hole_card, round_state, hand)
  ...
  def __parse_ask_message(self, message):
    ...
    hand = message["hand"] if "hand" in message else None
    return valid_actions, hole_card, round_state, hand
