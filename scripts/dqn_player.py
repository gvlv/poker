...
class DQNPlayer(LogPlayer):
    ...
    def __init__(self, h_size=128, lr=0.0001, gradient_clip_norm=500, total_num_actions=5, is_double=False,
                 is_main=True, is_restore=False, is_train=True, debug=False, write_log=False, decrease_coefficient=1.,
                 gpu_num=-1):
        super().__init__(write_log=write_log, decrease_coefficient=decrease_coefficient)
        self.h_size = h_size
        self.lr = lr
